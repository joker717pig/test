...
//==============================================MAX30102硬件接口==================================================
// 修改为GPIOB引脚：SCL-B10, SDA-B11, INT-B12
...
#define 	MAX30102_IIC_SCL				PBout(10)  // SCL输出 B10
#define 	MAX30102_IIC_SDA				PBout(11)  // SDA输出 B11
#define 	MAX30102_READ_SDA   			PBin(11)   // SDA输入 B11

#define		MAX30102_INT_CLK				RCC_APB2Periph_GPIOB
#define		MAX30102_INT_PORT				GPIOB
#define		MAX30102_INT_PIN		        GPIO_Pin_12
#define		MAX30102_INT            PBin(12)  // INT输入 B12
