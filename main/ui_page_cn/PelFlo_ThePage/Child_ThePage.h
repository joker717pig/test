#ifndef __CHILD_THEPAGE_H__
#define __CHILD_THEPAGE_H__
...
#include "lvgl.h"
#include "menu_ui.h"    /* [我们] Param_Data_t / Treat_Timer_Ctx_t（The_Param_Data1 extern 用） */
    /* 页面的数组保存位置 */
    typedef enum {
    ...
    /* [我们] 阶段C 治疗控制：Page4 参数对象（强度1/2 存于此），供事件文件/引擎读取 */
    extern Param_Data_t The_Param_Data1;
